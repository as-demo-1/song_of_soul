...
namespace Gamekit2D
{
        ...
        where TMonoBehaviour : MonoBehaviour
    {
        ...
        public float CurrentStatenormalizedTime { get; private set; }
        public AnimatorStateInfo NextStateInfo { get; private set; }
        public float NextStatenormalizedTime { get; private set; }
        ...
        public sealed override void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex, AnimatorControllerPlayable controller)
        {
            ...
            CurrentStatenormalizedTime = CurrentStateInfo.normalizedTime;
            NextStateInfo = animator.GetNextAnimatorStateInfo(layerIndex);
            NextStatenormalizedTime = NextStateInfo.normalizedTime;

            if (animator.IsInTransition(layerIndex) && NextStateInfo.fullPathHash == stateInfo.fullPathHash)
            {
            ...
            if (animator.IsInTransition(layerIndex) && CurrentStateInfo.fullPathHash == stateInfo.fullPathHash)
            {
