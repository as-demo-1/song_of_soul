...
Shader "XIXI/Add" {
    Properties {
        ...
        _fn_v ("fn_v", Range(0, 1)) = 0.5048544
        _NiuQu ("NiuQu", 2D) = "white" {}
        [MaterialToggle] _NQOff ("NQOff", Float ) = 0
        [MaterialToggle] _IntorCurver ("Int or Curver", Float ) = 0
        ...
        _Rotator_mask ("Rotator_mask", Float ) = 0
        [MaterialToggle] _Disslove_niuqu ("Disslove_niuqu", Float ) = 0
        _NiuQu_disslove ("NiuQu_disslove", 2D) = "white" {}
        _UspeedNiuqu_niuqu ("U speed Niuqu_niuqu", Float ) = 0
        _VSpeedNiuquniuqu ("V Speed Niuquniuqu", Float ) = 0
        _disslove_niuqu_power ("disslove_niuqu_power", Float ) = 0
        _NiuQu_mask ("NiuQu_mask", 2D) = "white" {}
        [MaterialToggle] _mask_niuqu_copy ("mask_niuqu_copy", Float ) = 0
        _mask_niuqu_power_copy ("mask_niuqu_power_copy", Float ) = 0
        _UspeedNiuqu_niuqu_mask ("U speed Niuqu_niuqu_mask", Float ) = 0
        _VSpeedNiuqu_mask ("V Speed Niuqu_mask", Float ) = 0
        _Ram_Rotator ("Ram_Rotator", Float ) = 0
    }
    SubShader {
        Tags {
